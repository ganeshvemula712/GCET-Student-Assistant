...
export default function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#050816] text-white overflow-x-hidden selection:bg-indigo-500 selection:text-white">
      {/* LEFT HERO SECTION (Desktop Split Screen) */}
      <div className="relative hidden lg:flex w-1/2 flex-col justify-between p-12 xl:p-16 bg-gradient-to-br from-[#0B1120] via-[#0D1527] to-[#050816] border-r border-white/10 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none translate-x-1/3 translate-y-1/3" />
        ...
        {/* Center Main Hero & Headline Content */}
        <div className="relative z-10 my-auto py-10 max-w-xl space-y-6">
          ...
          <p className="text-base text-gray-300 leading-relaxed max-w-lg">
            Instant, verified academic guidance, course syllabus assistance, regulations, and placement information powered by GCET Knowledge Engine.
          </p>

          {/* Three Feature Cards */}
          <div className="grid grid-cols-3 gap-3 pt-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-md transition hover:border-indigo-500/40">
              <div className="flex size-8 items-center justify-center rounded-xl bg-indigo-500/20 text-indigo-400 mb-2">
                <BookOpen size={16} />
              </div>
              <h4 className="text-xs font-bold text-white">Academic Support</h4>
              <p className="text-[11px] text-gray-400 mt-1 leading-snug">Course syllabus & exam guidance</p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-md transition hover:border-cyan-500/40">
              <div className="flex size-8 items-center justify-center rounded-xl bg-cyan-500/20 text-cyan-400 mb-2">
                <Sparkles size={16} />
              </div>
              <h4 className="text-xs font-bold text-white">Smart & Reliable</h4>
              <p className="text-[11px] text-gray-400 mt-1 leading-snug">Grounded in institutional docs</p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-md transition hover:border-emerald-500/40">
              <div className="flex size-8 items-center justify-center rounded-xl bg-emerald-500/20 text-emerald-400 mb-2">
                <ShieldCheck size={16} />
              </div>
              <h4 className="text-xs font-bold text-white">Secure & Private</h4>
              <p className="text-[11px] text-gray-400 mt-1 leading-snug">Student data protection</p>
            </div>
          </div>
        </div>

        {/* Bottom Student Quote Card */}
        <div className="relative z-10 rounded-2xl border border-white/10 bg-[#0F172A]/80 p-4.5 backdrop-blur-md">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs italic text-gray-300 leading-relaxed">
                "GCET AI Assistant transformed how students access academic regulations and course info instantly."
              </p>
              <p className="mt-1.5 text-[11px] font-bold text-indigo-400">
                — GCET Academic Portal & Student Services
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-5 sm:p-10 lg:p-16 relative z-10 min-h-screen">
        {/* Mobile Header Branding */}
        <div className="lg:hidden mb-8 flex justify-center">
          <GcetLogo showText={true} />
        </div>

        <div className="w-full max-w-[440px] rounded-3xl border border-gray-800 bg-[#0B1120]/95 p-7 sm:p-9 shadow-2xl backdrop-blur-2xl relative">
