    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <h3 className="mt-4 text-xl font-bold text-white">Delete Conversation?</h3>
          <p className="mt-2 text-xs leading-relaxed text-gray-400">
            Are you sure you want to delete <strong className="text-white">"{title}"</strong>? This will permanently remove the conversation and message history. This action cannot be undone.
          </p>
