    ...
    <aside className="fixed left-0 top-0 hidden h-screen w-56 border-r border-white/10 bg-[#0B1120] lg:flex lg:flex-col">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-xs font-bold transition ${
                  isActive ? "bg-indigo-600 text-white shadow-md shadow-indigo-600/30" : "text-gray-300 hover:bg-white/10 hover:text-white"
                }`
              }
            >
      ...
      <div className="border-t border-white/10 p-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl bg-rose-600/90 px-3.5 py-2.5 text-xs font-bold text-white transition hover:bg-rose-600 shadow-md shadow-rose-600/20 cursor-pointer"
        >
