...
export default function AuthLayout({ children }) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#050816] font-[Inter,ui-sans-serif,system-ui,sans-serif] text-white flex flex-col justify-center items-center py-3 sm:py-4 px-4 sm:px-8 selection:bg-indigo-500 selection:text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen lg:min-h-[calc(100vh-2rem)] w-full max-w-6xl flex-col justify-center py-2 lg:grid lg:grid-cols-[57%_43%] lg:items-center lg:gap-8 xl:gap-12 min-w-0">
